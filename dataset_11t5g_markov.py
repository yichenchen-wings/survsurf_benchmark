...
class DatasetMarkovSurvSurf(Dataset):
    def __init__(
            ...
            mode:Literal['first_cross_obs_only', 'first_last_obs_per_g', 'first_cross_obs_only_more_g', 'full_traj_obs_only', 'all_tg', 'true_probs_grid'],
...
class DataModuleMarkovSurvSurf(LightningDataModule):
    def __init__(
            ...
            batch_size, 
            num_workers,
            train_mode:Literal['first_cross_obs_only', 'first_cross_obs_only_more_g', 'full_traj_obs_only','first_last_obs_per_g','all_tg'],
